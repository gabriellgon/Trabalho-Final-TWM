...
const Funcionario = (props) => {
    ...
    const handleSalvar = async () => {
        ...
        const res = await axios.post("http://localhost:5000/funcionarios", funcionario, {
            headers: {
    ...
    const handlePesquisar = async (nomePesquisa) => {
        await axios
          .get(`http://localhost:5000/funcionarios/?nome=${nomePesquisa}`)
          .then((resposta) => {
            setNome(resposta.data.nome);
            setEmail(resposta.data.email);
            setCPF(resposta.data.cpf);
            setCEP(resposta.data.cep);
            setNumeroCasa(resposta.data.numeroCasa);
    ...
    return (
        <div>
            <div className="CadastroFuncionarios">
                        ...
                        <Container>
                            <Row>
                                ...
                                <Col>
                                    ...
                                    <ModalPesquisa
                                        titulo={"Pesquisa de Funcionarios"}
                                        show={showPesquisa}
